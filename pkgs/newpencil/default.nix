...
stdenv.mkDerivation rec {
  ...
  preFixup = let
    # we prepare our library path in the let clause to
    # avoid it become part of the input of mkDerivation
    packages = [
      alsaLib
      atk
      cairo
  ...
  in ''
    ...
    chmod u+x $out/opt/Pencil/libffmpeg.so
    chmod g+x $out/opt/Pencil/libffmpeg.so
  ...
  postFixup = ''
    ...
    # necessary to to find the libudev
  ...
  meta = with stdenv.lib; {
    ...
    maintainers = with maintainers; [ bjornfor prikhi mrVanDao ];
